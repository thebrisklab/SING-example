...
dXcentered%*%rep(1,pX) #X_c 1=0
t(rep(1,n))%*%dXcentered #1^\top X_c = 0^\top
# Two points for Ben:
# note: these are not equal to 0. 
# simulation does not use double-centering, 
# come back to this point. 

# the examples do not use variance normalization.
# What happens when we perform the iterative double-whitening with columns scaling?

#### Answer from Liangkang:
#### centered matrix are used in the SING and joint ICA decomposition




# Also create the joint signal matrix
# used later to calculate accuracy:
...
## Apply JointICA
########################################################
# this section performs jointICA on the 
