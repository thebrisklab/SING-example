...
knitr::include_graphics("figs/Original data figure.png")
```



### Pipeline of SING method
The data process code can be found in the two code file mentioned before.
...
knitr::include_graphics("figs/Joint X component.png")
```
...
knitr::include_graphics("figs/Joint Y component.png")
```
...
knitr::include_graphics("figs/Subject Score.png")
```
